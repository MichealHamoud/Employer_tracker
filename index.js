...
const addEmployee = async () => {
  await inquirer
    ...
    .then((data) => {
      connection.query(
        `CREATE TEMPORARY TABLE temp_manager_ids SELECT id FROM employees WHERE first_name = '${data.firstN_m}' AND last_name = 
        '${data.lastN_m}';INSERT INTO employees (first_name, last_name, role_id, manager_id) VALUES ('${data.firstN}', '${data.lastN}', 
...
// Function to update the manager role
